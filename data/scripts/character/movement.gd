...
var s_speed : float = 14; # Sprint
var w_speed : float = 28; # Walking
...
func _crouch(_delta) -> void:
	# Inputs
	input["crouch"] = int(Input.is_action_pressed("KEY_CTRLs"));
...
func _sprint(_delta) -> void:
	# Inputs
	input["sprint"] = int(Input.is_action_pressed("KEY_SHIFTs"));
